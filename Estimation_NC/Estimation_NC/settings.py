"""
Django settings for Estimation_NC project.
...
SECRET_KEY = 'hw(5e)))z6uim$b2f8j!d)9&(1=c753_un^w9c4h_p(*_)yrgs'
...
ROOT_URLCONF = 'Estimation_NC.urls'
...
WSGI_APPLICATION = 'Estimation_NC.wsgi.application'
